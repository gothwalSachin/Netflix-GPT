export const NOW_PLAYING_MOVIES_URL = 'https://api.themoviedb.org/3/movie/now_playing?page=1&language=';

export const POPULAR_MOVIES_URL = 'https://api.themoviedb.org/3/movie/popular?page=1&language=';

export const TOP_RATED_MOVIES_URL = 'https://api.themoviedb.org/3/movie/top_rated?page=1&language=';

export const UPCOMING_MOVIES_URL = 'https://api.themoviedb.org/3/movie/upcoming?page=1&language=';
