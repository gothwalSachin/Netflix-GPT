                ...
                <div className="text-white bg-black opacity-80 shadow-2xl w-2/6 p-12 m-auto rounded-sm">
                    ...
                    <form onSubmit={(e) => e.preventDefault()}>
                        <div className='group relative mb-3'>
                            <input required type="email" id='email' className={'px-5 pt-4 h-16 w-full border-2 rounded-sm outline-0 peer ' + (errorMessage.length !== 0 ? 'border-red-700' : 'border-neutral-400 focus:border-white') } ref={email} />
                        ...
                        <div className='group relative mb-3'>
                            <input required type="password" className={'px-5 pt-4 h-16 w-full border-2 rounded-sm outline-0 peer ' + (errorMessage.length !== 0 ? 'border-red-700' : 'border-neutral-400 focus:border-white' )} ref={password} />
