...
const VideoTitle = (props: {title: string, overview: string}) => {
    ...
    return (
        <div className="px-5 lg:px-12 text-white absolute w-full aspect-video bg-gradient-to-r from-black pt-40 sm:pt-45 lg:pt-50 mb-24 lg:mb-4">
            <h1 className="text-base sm:text-lg md:text-4xl font-bold m-5">{props.title}</h1>
